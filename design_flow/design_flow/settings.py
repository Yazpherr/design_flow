"""
Django settings for design_flow project.

Generated by 'djangocms' command using django CMS 4.1.4 and Django 5.1.5.
...
SECRET_KEY = 'django-insecure-3a2@g=4$3!q1l1d526h&z%5wzc9g(t-(bfj(%i87*vjiy)dai7'
...
ROOT_URLCONF = 'design_flow.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "design_flow", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'design_flow.wsgi.application'
